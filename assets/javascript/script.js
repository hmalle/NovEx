...
$(document).ready(function() {
  ...
  // empty profiles before appending
    $("#profiles").empty();
   ...
   database.ref().orderByChild("dateAdded").limitToLast(5).once("value", function(childSnapshot){
    ...
    console.log(JSON.stringify(childSnapshot));
		$("#profiles").append("<div class='card'><div class='card-header'>"+ dataName+"</div><div class='card-body'><p>Location: "+dataLoc +"</p><p>Trade: "+dataTrade+"</p><p>contact: "+dataContact+"</p></div>");
	});
